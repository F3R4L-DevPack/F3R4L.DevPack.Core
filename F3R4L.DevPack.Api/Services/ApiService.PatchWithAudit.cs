...
namespace F3R4L.DevPack.Api.Services
{
    ...
    {
        public async Task<RequestOnlyAuditContainer<TIn>> PatchAsync<TIn>(AuditablePatchEndpoint<TIn> endpoint, TIn request,
            string contentType = "application/json")
        {
            ...
            try
            {
                ...
                httpResponse = await _httpClient.PatchAsync(endpoint.Address,
        ...
        public async Task<AuditContainer<TIn, TOut>> PatchAsync<TIn, TOut>(AuditablePatchEndpoint<TIn, TOut> endpoint, TIn requestObject,
            string contentType = "application/json")
            where TIn : class
        {
